  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-4 text-white">
      <div className="flex relative size-full items-center justify-center">
        ...
        <div className={cn('hidden h-[calc(100vh-86px)] ml-2', { 'show-block': showParticipants })}>
      ...
      <div className="fixed bottom-0 flex w-full items-center justify-center gap-5 flex-wrap">
        ...
        <DropdownMenu>
          <div className="flex items-center">
            <DropdownMenuTrigger className="rounded-2xl cursor-pointer px-4 py-2 bg-[#19232d] hover:bg-[#4c535b]">
        ...
        <button onClick={() => setShowParticipants((prev) => !(prev))}>
          <div className="rounded-2xl cursor-pointer px-4 py-2 bg-[#19232d] hover:bg-[#4c535b]">
